...
git clone --depth=1 https://github.com/kibria5/android_kernel_xiaomi_violet.git -b 14 kernel/xiaomi/violet 
...
git clone --depth=1 https://gitlab.com/Joker-V2/android_vendor_MiuiCamera vendor/MiuiCamera
