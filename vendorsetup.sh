...
git clone --depth=1 https://github.com/Joker-V2/kernel_xiaomi_violet.git -b fourteen kernel/xiaomi/violet
...
git clone https://github.com/selfmusing/meme_cam.git vendor/MiuiCamera
